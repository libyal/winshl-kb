...
# Change PYTHONPATH to include winshlrc module and dependencies.
sys.path.insert(0, os.path.abspath('..'))

import winshlrc  # pylint: disable=wrong-import-position
...
project = 'Windows Shell knowledge base'
copyright = 'The Windows Shell knowledge base authors'
version = winshlrc.__version__
release = winshlrc.__version__
...
def RunSphinxAPIDoc(app):
  ...
  module_path = os.path.join(current_directory, '..', 'winshlrc')
